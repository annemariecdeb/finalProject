...
function validateInput() {
    ...
    if (fname.value && lname.value) {} else if (fname.value) // means if the fname is empty
...
function validateInput() {
    ...
    } else if (email.value) // means if the email is empty
        error = "<b><i>You can't leave your email empty. We promise not to send any kitten gifs.</b></i>";
    else if (tel.value) // means if the fname is empty
